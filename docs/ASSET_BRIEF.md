...
| ------------------------------------------- | ---------- | -------------------- | ----------------------------------- | --------------------- | ---------- | ------------------------ |
| `assets/images/icon.png`                    | Procedural | Codex / script local | `scripts/generate-brand-assets.cjs` | Gerado para o projeto | 2026-09-15 | Ícone provisório do app  |
| `assets/images/favicon.png`                 | Procedural | Codex / script local | `scripts/generate-brand-assets.cjs` | Gerado para o projeto | 2026-09-15 | Favicon provisório       |
| `assets/images/splash-icon.png`             | Procedural | Codex / script local | `scripts/generate-brand-assets.cjs` | Gerado para o projeto | 2026-09-15 | Splash provisório        |
| `assets/images/android-icon-foreground.png` | Procedural | Codex / script local | `scripts/generate-brand-assets.cjs` | Gerado para o projeto | 2026-09-15 | Adaptive icon provisório |
| `assets/images/android-icon-monochrome.png` | Procedural | Codex / script local | `scripts/generate-brand-assets.cjs` | Gerado para o projeto | 2026-09-15 | Themed icon provisório   |
| `assets/vectors/control-mark.svg`           | Vetorial   | Codex / código local | Geometria CONTROL original          | Gerado para o projeto | 2026-09-15 | Símbolo e UI             |
| `assets/vectors/control-wordmark.svg`       | Vetorial   | Codex / código local | Lettering CONTROL original          | Gerado para o projeto | 2026-09-15 | Wordmark                 |
| `assets/vectors/control-splash.svg`         | Vetorial   | Codex / código local | Geometria CONTROL original          | Gerado para o projeto | 2026-09-15 | Fonte vetorial do splash |
